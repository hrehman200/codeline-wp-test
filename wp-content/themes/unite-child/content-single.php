...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="entry-content">
        ...
        ?>
        <div><b>Genre: </b><?= implode("", $genre) ?></div>
        <div><b>Countries: </b><?= implode("", $countries) ?></div>
        <div><b>Ticket Price: </b>$<?php echo get_post_custom_values('ticket_price', get_the_ID())[0]; ?></div>
        <div><b>Release Date: </b><?php echo get_post_custom_values('release_date', get_the_ID())[0]; ?></div>
        <br/>
